<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ITLab.Challenges.EasterChallengeWebService.Account.OpenAuthProviders" %>
